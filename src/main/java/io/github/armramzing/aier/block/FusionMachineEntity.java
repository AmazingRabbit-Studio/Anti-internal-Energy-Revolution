...
import io.github.armramzing.aier.screen.FusionMachineScreenHandler;
...
public class FusionMachineEntity extends BlockEntity
    ...
    public FusionMachineEntity() {
        super(Blocks.FUSION_MACHINE_ENTITY);
    }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory inv, PlayerEntity player) {
        return new FusionMachineScreenHandler(syncId, inv, this);
    }
