...
import io.github.armramzing.aier.screen.CompressorScreenHandler;
import io.github.armramzing.aier.screen.ShapingMachineScreenHandler;
...
public class ShapingMachineEntity extends BlockEntity
    ...
    public ShapingMachineEntity() {
        super(Blocks.SHAPING_MACHINE_ENTITY);
    }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory inv, PlayerEntity player) {
        return new ShapingMachineScreenHandler(syncId, inv, this);
    }
